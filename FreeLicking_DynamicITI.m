...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'ResponsePort1', ...
        ...
        'StateChangeConditions', {'GlobalTimer2_End', 'DelayPeriod_0', 'Port1Out', 'RewardPort1'}, ...
        'OutputActions', {});
    ...
    sma = AddState(sma, 'Name', 'DebouncePort1', ...
        ...
        'StateChangeConditions', {'Tup', 'ResponsePort1', 'GlobalTimer2_End', 'DelayPeriod_0'}, ...
        'OutputActions', {});
    ...
    sma = AddState(sma, 'Name', 'ResponsePort2', ...
        'Timer', 1000, ...  % Safety timeout (won't be reached)
        'StateChangeConditions', {'GlobalTimer2_End', 'DelayPeriod_0', 'Port2Out', 'RewardPort2'}, ...
        'OutputActions', {});
    ...
    sma = AddState(sma, 'Name', 'DebouncePort2', ...
        'Timer', S.GUI.DebounceDuration, ...
        'StateChangeConditions', {'Tup', 'ResponsePort2', 'GlobalTimer2_End', 'DelayPeriod_0'}, ...
        'OutputActions', {});

    % ===== DELAY PERIOD: 2-second wait without licking (split into 4 x 0.5s for visibility) =====
    % Quarter 1 (0-0.5s)
    sma = AddState(sma, 'Name', 'DelayPeriod_0', ...
        'Timer', S.GUI.DelayDuration / 4, ...
        'StateChangeConditions', {'Tup', 'DelayPeriod_1', 'Port1Out', 'BurstWindow', 'Port2Out', 'BurstWindow'}, ...
        'OutputActions', {});

    % Quarter 2 (0.5-1.0s)
    sma = AddState(sma, 'Name', 'DelayPeriod_1', ...
        'Timer', S.GUI.DelayDuration / 4, ...
        'StateChangeConditions', {'Tup', 'DelayPeriod_2', 'Port1Out', 'BurstWindow', 'Port2Out', 'BurstWindow'}, ...
        'OutputActions', {});

    % Quarter 3 (1.0-1.5s)
    sma = AddState(sma, 'Name', 'DelayPeriod_2', ...
        'Timer', S.GUI.DelayDuration / 4, ...
        'StateChangeConditions', {'Tup', 'DelayPeriod_3', 'Port1Out', 'BurstWindow', 'Port2Out', 'BurstWindow'}, ...
        'OutputActions', {});

    % Quarter 4 (1.5-2.0s) - final quarter
    sma = AddState(sma, 'Name', 'DelayPeriod_3', ...
        'Timer', S.GUI.DelayDuration / 4, ...
    ...
    sma = AddState(sma, 'Name', 'BurstWindow', ...
        ...
        'StateChangeConditions', {'Tup', 'DelayPeriod_0'}, ...  % Return to start of delay (resets timer)
        'OutputActions', {});
