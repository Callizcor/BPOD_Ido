...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'ResponsePort1', ...
        ...
        'StateChangeConditions', {'GlobalTimer2_End', 'Delay_2.0s', 'Port1Out', 'RewardPort1'}, ...
        'OutputActions', {});
    ...
    sma = AddState(sma, 'Name', 'DebouncePort1', ...
        ...
        'StateChangeConditions', {'Tup', 'ResponsePort1', 'GlobalTimer2_End', 'Delay_2.0s'}, ...
        'OutputActions', {});
    ...
    sma = AddState(sma, 'Name', 'ResponsePort2', ...
        'Timer', 1000, ...  % Safety timeout (won't be reached)
        'StateChangeConditions', {'GlobalTimer2_End', 'Delay_2.0s', 'Port2Out', 'RewardPort2'}, ...
        'OutputActions', {});
    ...
    sma = AddState(sma, 'Name', 'DebouncePort2', ...
        'Timer', S.GUI.DebounceDuration, ...
        'StateChangeConditions', {'Tup', 'ResponsePort2', 'GlobalTimer2_End', 'Delay_2.0s'}, ...
        'OutputActions', {});

    % ===== DELAY PERIOD: 2-second countdown (split into 0.5s segments for visibility) =====
    % Delay: 2.0s remaining
    sma = AddState(sma, 'Name', 'Delay_2.0s', ...
        'Timer', S.GUI.DelayDuration / 4, ...
        'StateChangeConditions', {'Tup', 'Delay_1.5s', 'Port1Out', 'BurstWindow', 'Port2Out', 'BurstWindow'}, ...
        'OutputActions', {});

    % Delay: 1.5s remaining
    sma = AddState(sma, 'Name', 'Delay_1.5s', ...
        'Timer', S.GUI.DelayDuration / 4, ...
        'StateChangeConditions', {'Tup', 'Delay_1.0s', 'Port1Out', 'BurstWindow', 'Port2Out', 'BurstWindow'}, ...
        'OutputActions', {});

    % Delay: 1.0s remaining
    sma = AddState(sma, 'Name', 'Delay_1.0s', ...
        'Timer', S.GUI.DelayDuration / 4, ...
        'StateChangeConditions', {'Tup', 'Delay_0.5s', 'Port1Out', 'BurstWindow', 'Port2Out', 'BurstWindow'}, ...
        'OutputActions', {});

    % Delay: 0.5s remaining - final segment
    sma = AddState(sma, 'Name', 'Delay_0.5s', ...
        'Timer', S.GUI.DelayDuration / 4, ...
    ...
    sma = AddState(sma, 'Name', 'BurstWindow', ...
        ...
        'StateChangeConditions', {'Tup', 'Delay_2.0s'}, ...  % Return to start of delay (resets timer)
        'OutputActions', {});
